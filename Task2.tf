...
depends_on =  [ aws_key_pair.tk2key, aws_security_group.tk2_sg, ]
...
depends_on =  [ aws_security_group.tk2_sg, aws_instance.tk2_os,  ]
...
"sudo curl https://github.com/Varuni17/Hybrid-Task-2.git > index.html",                                  "sudo cp index.html  /var/www/html/",
]
}
}
//creation of S3 bucket//
resource "aws_s3_bucket" "task2-s3bucket" {
depends_on = [null_resource.null-remote-1,]
...
key    = "one"
source = "C:/Users/LENOVO/Desktop/tera/terratask2/picture.jpg"
etag = "C:/Users/LENOVO/Desktop/tera/terratask2/picture.jpg"
acl = "public-read"
...
inline = [
"sudo su << EOF",
"echo \"<img src='https://${aws_cloudfront_distribution.tk2-s3_distribution.domain_name}/${aws_s3_bucket_object.task2-object.key }'>\" >> /var/www/html/index.html",
"EOF"
]
}
}
